...
type TimeSeriesChunk struct {
	...
	Token          uint32         `protobuf:"varint,5,opt,name=token,proto3" json:"token,omitempty"`
}
...
func (m *TimeSeriesChunk) GetToken() uint32 {
	if m != nil {
		return m.Token
	}
	return 0
...
func (m *TimeSeries) GetToken() uint32 {
	if m != nil {
		return m.Token
	}
	return 0
...
func (m *TimeSeriesChunk) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Token != 0 {
		dAtA[i] = 0x28
		i++
		i = encodeVarintCortex(dAtA, i, uint64(m.Token))
	}
	return i, nil
}
